...
// now we create firebase event listner for adding trains to database and a row in the html when the user adds an entry
...
// first Train pushed back 0 days to make sure it comes before current time
  var firstTimeConverted = moment(firstTrain,"HH:mm").subtract(0, "days");
